...
int main(int argc, char *argv[]) {
    ...
    // Validating arguments and opening file
    if (argc >= 2) {
    ...
    do {
        ...
        switch (tolower(choice)) {
            ...
            case 'i':
                ...
                break;
            // Adding boat data from user input and sorting
            case 'a':
                char boatData[1000] = "";
            ...
            case 'r':
                ...
                break;
            // Accepting payment for boat, up to amount owed
            case 'p':
                found = 0;
                printf("Please enter the boat name                               : ");
                scanf(" %[^\n]", Name);
                ...
                break;
            // Updating amount owed for new month
            case 'm':
              MonthlyUpdate(BoatRecord, totalBoats);
              break;
            // Exit with message and saving to CSV
            case 'x':
